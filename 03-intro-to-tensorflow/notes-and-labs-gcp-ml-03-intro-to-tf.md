...
# Lab 5: Scaling TensorFlow with Cloud MLE
...
In Cloud Datalab, click on the **Home** icon, and then navigate to **datalab > notebooks > training-data-analyst > courses > machine_learning > deepdive > 03_tensorflow > labs** and open **e_cloudmle.ipynb**.
...
* change lab2 to files!
* redo lab 3 (c_dataset) (!) -- adapt to look like lab2! (and maybe use eager execution)
